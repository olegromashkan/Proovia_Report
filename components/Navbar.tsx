                ...
                <div className="p-4 flex flex-col h-[400px]">
                  ...
                  <div className="flex items-center justify-between p-3 mt-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-750 rounded-lg">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={handleForceRefresh} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-150" aria-label="Force refresh">
