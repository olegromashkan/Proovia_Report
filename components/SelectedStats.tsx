...
interface Props {
  ...
  items: Trip[];
  isLeft: boolean;
  getTasks: (cal?: string) => string;
  getDuration: (trip: Trip, isLeft: boolean) => number;
  formatDuration: (mins: number) => string;
}

export default function SelectedStats({ selected, items, isLeft, getTasks, getDuration, formatDuration }: Props) {
