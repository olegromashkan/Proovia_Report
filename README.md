...
to a scrollable list that keeps the look of calendar cells. The
full report page has been adjusted so its tables and summary
cards scroll horizontally when space is limited.
